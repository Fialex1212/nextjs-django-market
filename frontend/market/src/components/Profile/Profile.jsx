      ...
      <div className="container">
        ...
        <ul className={css.buttons__list}>
          <li className={css.list__item}>
            <Link className={css.list__link} href="/profile/history">
              History
            </Link>
          </li>
          <li className={css.list__item}>
            <Link className={css.list__link} href="/cart">
              Cart
            </Link>
          </li>
          <li className={css.list__item}>
            <Link className={css.list__link} href="/profile/orders">
              Orders
            </Link>
          </li>
          <li className={css.list__item}>
            <Link className={css.list__link} href="/profile/settings">
              Settings
            </Link>
          </li>
          <li className={css.list__item}>
